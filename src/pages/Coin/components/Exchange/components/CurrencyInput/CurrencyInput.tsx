  ...
  return (
    <div className='w-full'>
      <div className='flex flex-col gap-1.5 sm:gap-2 w-full'>
        ...
        <div className='px-3 sm:px-4 rounded-xl sm:rounded-2xl bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/20 transition-all duration-300 w-full h-11 sm:h-14 flex items-center focus-within:bg-white/10 focus-within:border-(--brand-blue)/50 focus-within:shadow-[0_0_30px_rgba(0,240,255,0.1)]'>
          <input
