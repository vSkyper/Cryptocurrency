...
const BADGE_CONTAINER_CLASSES =
  'inline-flex items-center p-2 sm:p-3 rounded-2xl ' +
  'bg-[color-mix(in_srgb,var(--brand-blue)_10%,transparent)] ' +
  'hover:bg-[color-mix(in_srgb,var(--brand-blue)_15%,transparent)] ' +
  'transition-all duration-200 max-w-xs mx-auto sm:mx-0 sm:w-auto mt-4 sm:mt-0 justify-center';

const BADGE_IMAGE_CLASSES =
  'h-8 sm:h-9 w-auto opacity-90 hover:opacity-100 transition-opacity duration-200';
