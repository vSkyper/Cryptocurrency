  ...
  return (
    <div className='flex items-center gap-2 sm:gap-3'>
      ...
      <Link
        ...
        className='inline-flex items-center justify-center bg-gradient-to-br from-[color-mix(in_srgb,var(--brand-blue)_15%,transparent)] to-[color-mix(in_srgb,var(--brand-blue)_8%,transparent)] backdrop-blur-md border border-[color-mix(in_srgb,var(--brand-blue)_20%,transparent)] rounded-lg text-[var(--brand-blue)] transition-all duration-300 ease-out p-1.5 sm:p-2 relative overflow-hidden group hover:bg-gradient-to-br hover:from-[color-mix(in_srgb,var(--brand-blue)_25%,transparent)] hover:to-[color-mix(in_srgb,var(--brand-blue)_15%,transparent)] hover:-translate-y-0.5 hover:scale-105 hover:shadow-[0_8px_25px_color-mix(in_srgb,var(--brand-blue)_25%,transparent),0_4px_12px_rgba(0,0,0,0.15)] hover:border-[color-mix(in_srgb,var(--brand-blue)_40%,transparent)] active:-translate-y-px active:scale-[1.02]'
      >
        {/* Shine effect */}
        <span className='absolute top-0 -left-full w-full h-full bg-gradient-to-r from-transparent via-[color-mix(in_srgb,var(--brand-blue)_20%,transparent)] to-transparent transition-all duration-500 group-hover:left-full' />
        <TrendingUpIcon
          sx={{ fontSize: '1.4rem' }}
