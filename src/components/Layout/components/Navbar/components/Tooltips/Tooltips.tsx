...
export default function Tooltips() {
  return (
    <a
      ...
      className='inline-flex items-center justify-center bg-gradient-to-br from-[color-mix(in_srgb,var(--brand-blue)_12%,transparent)] to-[color-mix(in_srgb,var(--brand-blue)_6%,transparent)] backdrop-blur-[12px] border border-[color-mix(in_srgb,var(--brand-blue)_20%,transparent)] rounded-lg text-[var(--brand-blue)] transition-all duration-300 ease-out p-2.5 sm:p-3 relative overflow-hidden group hover:bg-gradient-to-br hover:from-[color-mix(in_srgb,var(--brand-blue)_20%,transparent)] hover:to-[color-mix(in_srgb,var(--brand-blue)_12%,transparent)] hover:-translate-y-0.5 hover:scale-105 hover:shadow-[0_8px_25px_color-mix(in_srgb,var(--brand-blue)_25%,transparent),0_4px_12px_rgba(0,0,0,0.15)] hover:border-[color-mix(in_srgb,var(--brand-blue)_40%,transparent)] active:-translate-y-px active:scale-[1.02]'
    >
      {/* Shine effect */}
